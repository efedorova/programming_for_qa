...
public class TestBase {
	...
	protected void fillContactForm(ContactDate contact) {
	    ...
	    driver.findElement(By.name("email2")).sendKeys(contact.reserveEmail);
	 // добавить условие для разных методов
	    new Select(driver.findElement(By.name("bday"))).selectByIndex(Integer.parseInt(contact.bday)); 
	 // добавить условие для разных методов
	    new Select(driver.findElement(By.name("bmonth"))).selectByIndex(Integer.parseInt(contact.bmonth));
	    driver.findElement(By.name("byear")).clear();
	    driver.findElement(By.name("byear")).sendKeys(contact.byear);
	 // добавить условие для разных методов
	    new Select(driver.findElement(By.name("new_group"))).selectByIndex(Integer.parseInt(contact.selectedGroup));
	    driver.findElement(By.name("address2")).clear();
	    driver.findElement(By.name("address2")).sendKeys(contact.secondAddress);
	    driver.findElement(By.name("phone2")).clear();
	    driver.findElement(By.name("phone2")).sendKeys(contact.secondPhoneNumber);
	}
